...
const ReviewModal:React.FC<any> = ({ setShowReview, productId, refresh, setRefresh }) => {
  ...
  const handleChange = (name:string) => (e:ChangeEvent<HTMLSelectElement | HTMLInputElement | any>) => {
    e.preventDefault();
            ...
            <form className="p-4 md:p-5">
              <div className="grid gap-4 mb-4 grid-cols-2">
                <div className="col-span-2 sm:col-span-1">
                  ...
                  >
                    <option selected={undefined}>Select ratings</option>
