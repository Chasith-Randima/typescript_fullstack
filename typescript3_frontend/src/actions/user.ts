...
export const getProfile = (id:string, token?:string) => {
...
export const updateProfile = (id?:string, user?:any, token?:string) => {
  let url = `${API}/users/${id}`;
...
export const updateUserPassword = (id:string, user:any, token?:string) => {
...
export const getAllUsers = (paramsData:any, token:string) => {
  let url = `${API}/users`;
  let userRole;
...
export const oneUser = (id:string) => {
  let url = `${API}/users/${id}`;
